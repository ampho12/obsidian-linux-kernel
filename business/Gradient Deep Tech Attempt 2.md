...
Semi-generalizable robotics has just crossed from tier 1 into tier 2 in the last 12–18 months.
...
- _Research_ — n-gram, seq2seq, LSTM, transformer, GPT-1 — establishing feasibility.
- _Deep tech_ — GPT-2, GPT-3 — engineering supporting shortcomings in research rather than open feasibility questions.
- _Execution_ — today's mix of foundation and specialized models — iteration and deployment.
...
- **(X)** Ownership of gold-standard proprietary robotics data across multiple industrial verticals.
- **(Y)** Deep operational expertise in tightly integrating hardware and software systems.
...
_This phase funds seed and early Series A._
...
- Hardware generalization with modular design — absorbed by hires from Amazon, Matic, Tesla, Google modular hardware programs.
...
_This phase funds Series A and B._
...
- Scaling laws for robotics need to be empirically established. This is between tier 1 and tier 2, leaning tier 2 given the demonstrated precedent from language models.
- Sufficient data volume across verticals required to trigger the flywheel.

_This phase funds Series C and beyond._
...
Three powers hit cleanly — Counter-Positioning, Cornered Resource, Process Power — with two more developing (Scale Economies, Switching Costs). This is the strong-deep-tech profile: 2–3 powers strong, no overclaiming.

The accumulated lead at the moment of tier-3 entry is the combined integral of cross-vertical data + integration know-how + form-factor head start — a moat competitors entering later have to traverse from zero.
...
The current team is itself evidence the talent magnet is working: K-Scale Labs, Optimus, Google PI, Amazon Robotics, Matic Robots. These are engineers who could be earning at FAANG and have chosen this bet — and each is mapped to the specific tier-2 risk they're positioned to absorb.

The six-month hiring test post-seed will be: can the team add 4–5 additional exceptional engineers across software generalization (1–2 senior ML), hardware generalization (1–2 modular hardware), and operations? Failed-recruit conversations will be free diagnostic information on which component (vision or short-term reality) is the limiting factor — if either is weak.